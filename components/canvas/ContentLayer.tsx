  ...
  return (
    <div
      ...
      style={{
        position: 'absolute',
        inset: 0,
        paddingLeft: `${content.padding}px`,
        paddingRight: `${content.padding}px`,
        paddingTop: `${(content.padding / canvasWidth) * canvasHeight}px`,
        paddingBottom: `${(content.padding / canvasWidth) * canvasHeight}px`,
        display: 'flex',
        alignItems: 'center',
